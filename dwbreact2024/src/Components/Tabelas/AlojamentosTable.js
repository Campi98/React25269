...
const AlojamentosTable = () => {
    const formFields = [
        ...
        { label: 'ID da Viagem', type: 'number', name: 'iD_da_Viagem' }
    ];
    ...
    const tableRowData = ['ID_Alojamento', 'nome', 'localizacao', 'capacidade', 'precoPorNoite', 'descricao', 'dataDisponivel', 'proprietario', 'telefoneProprietario', 'iD_da_Viagem'];
